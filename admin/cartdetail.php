<?php 
    ...
    if (isset($_COOKIE["user"])) {
        ...
        if ($permission==1) {
            if (isset($_GET["id"])) {
                foreach (selectAll("SELECT * FROM chitiet WHERE id_donhang={$_GET['id']}") as $item) {
                            ...
                            <div class="card">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        $numrow = rowCount("SELECT * FROM chitiet WHERE id_donhang = {$_GET['id']}");
                                        $totalpage = ceil($numrow / $item_per_page);
                                        foreach (selectAll("SELECT * FROM chitiet WHERE id_donhang={$_GET['id']} LIMIT $item_per_page OFFSET $offset") as $item4) {

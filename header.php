                                    ...
                                    <?php 
                                        if (isset($_COOKIE["user"])) {
                                            ...
                                            if (rowCount("SELECT * FROM donhang WHERE id_taikhoan=$id_nguoidung && status=0")>0) {
                                                ...
                                                if(rowCount("SELECT * FROM chitiet WHERE id_donhang=$id_donhang")>0){
                                                ?>
                                                <span class='badge badge-danger' style='vertical-align: top; margin:-10px 0px 0px -10px; font-size:10px'><?= rowCount("SELECT * FROM chitiet WHERE id_donhang=$id_donhang") ?></span>
                                                <?php 
                                                } else{
                                                ?>
                                                    <span></span>

  ...
  <section class="cart_area padding_top1">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <div class="checkout_btn_inner">
                                        ...
                                        if($status ==1){
                                        ?>
                                           <p class="text-info" style="white-space: nowrap;">Chờ Giao Hàng</p>
                                           <a href="?huydon=<?= $idDh ?>" 
                                              class="btn-cancel" 
    ...
    <?php
        ...
        if (isset($_POST["dathang"])) {
            ...
            echo "<script>alert('Đặt hàng thành c��ng')
...
if (isset($_GET['huydon'])) {
    $id_donhang = $_GET['huydon'];
    // Chỉ cho phép hủy đơn khi trạng thái là "Chờ xác nhận"
    if (rowCount("SELECT * FROM donhang WHERE id=$id_donhang AND status=1") > 0) {
        selectAll("UPDATE donhang SET status=4 WHERE id=$id_donhang");
        echo "<script>
